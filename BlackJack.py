...
class Deck:
    ...
    def deal(self):
        ...
        if single_card.rank in ['Two', 'Three', 'Four', 'Five', 'Six']:
            self.card_counter +=1
            # print(self.card_counter)
        elif single_card.rank in ['Ten', 'Jack', 'Queen', 'King', 'Ace']:
            self.card_counter -= 1
            # print(self.card_counter)
        else:
            # print(self.card_counter)
        # print(single_card.rank)
        # print(self.card_counter)
        return single_card
...
while True:
    ...
    if shuffle_counter == 0:
        ...
        shuffle_counter += 1
        print('Shuffle')
        print(deck.card_counter)
    elif shuffle_counter == 30:
        deck = Deck()
        deck.shuffle()
        shuffle_counter = 0
        print('Shuffle')
    ...
    # Ask to play again
    new_game = input("yo, you playing? Enter 'ya' or 'na'")
    if new_game[0].lower() == 'ya':
        playing = True
        continue
    else:
