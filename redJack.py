"""
Modified Blackjack - Counting Enabled

Most of this code came from https://github.com/gsamarakoon/Fun-projects-for-Python/blob/master/A%20game%20of%20BlackJack.ipynb

I modified this game to 4 decks and to reshuffle after 30 hands
This game now counts cards and help you keep track
Chips now don't reset and amounts have been changed
    ...
    def __str__(self):
        ...
        for x in range(len(4)):
            for card in self.deck:
                deck_comp += '\n' + card.__str__() #add each card object;s
